...
def solution_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        # tf.keras.layers.LSTM(5, input_shape=(None, N_FEATURES)),
        tf.keras.layers.Conv1D(filters=32, kernel_size=5, strides=1, padding='causal', input_shape=[N_PAST, N_FEATURES]),
