...
# 1. 데이터
x_train = np.load('d:/study_data/_save/_npy/keras47_02_train_x.npy')
y_train = np.load('d:/study_data/_save/_npy/keras47_02_train_y.npy')
x_test = np.load('d:/study_data/_save/_npy/keras47_02_test_x.npy')
y_test = np.load('d:/study_data/_save/_npy/keras47_02_test_y.npy')
