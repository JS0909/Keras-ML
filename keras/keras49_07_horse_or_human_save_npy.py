...
np.save('d:/study_data/_save/_npy/keras49_07_train_x.npy', arr =x_train)
np.save('d:/study_data/_save/_npy/keras49_07_train_y.npy', arr =y_train)
np.save('d:/study_data/_save/_npy/keras49_07_test_x.npy', arr =x_test)
np.save('d:/study_data/_save/_npy/keras49_07_test_y.npy', arr =y_test)