...
end_time = time.time()
model.save('./_save/keras23_18_save_model_kaggle_titanic.h5')
# model = load_model('./_save/keras23_18_save_model_kaggle_titanic.h5')
...
# loss :  0.4904862344264984
# acc스코어 :  0.776536312849162
# 걸린 시간:  2.7803516387939453