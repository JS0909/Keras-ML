...
x_train = x_train.reshape(1003, 12, 1)
x_test = x_test.reshape(335, 12, 1)
...
log = model.fit(x_train, y_train, epochs=500, batch_size=100, callbacks=[Es], validation_split=0.2)
