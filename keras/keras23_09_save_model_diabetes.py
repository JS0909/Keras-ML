...
end_time = time.time()
model.save('./_save/keras23_09_save_model_diabetes.h5')
# model = load_model('./_save/keras23_09_save_model_diabetes.h5')
...
# loss :  [0.25510793924331665, 0.3400189280509949]
# r2스코어 :  0.817004294741068
# 걸린 시간:  43.07046437263489