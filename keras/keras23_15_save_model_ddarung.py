...
end_time = time.time()
model.save('./_save/keras23_15_save_model_ddarung.h5')
# model = load_model('./_save/keras23_15_save_model_ddarung.h5')
...
# loss:  [3345.826904296875, 41.007137298583984]
# r2:  0.6115078916519796
# 걸린 시간:  5.6921257972717285