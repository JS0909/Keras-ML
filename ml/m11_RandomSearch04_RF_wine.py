...
# 최적의 매개변수:  RandomForestClassifier(max_depth=8, min_samples_split=5, n_estimators=200)
# 최적의 파라미터:  {'n_estimators': 200, 'min_samples_split': 5, 'max_depth': 8}
# best_score_:  0.9785714285714286
# model.score:  1.0
# acc score:  1.0
# best tuned acc:  1.0
# 걸린시간:  3.03 초