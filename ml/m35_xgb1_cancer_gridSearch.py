...
# 최상의 매개변수:  {'alpha': 0.1, 'colsample_bylevel': 1, 'colsample_bynode': 0.1, 'colsample_bytree': 0.7, 'gamma': 0, 'lambda': 10, 'learning_rate': 1, 'max_depth': 3, 'min_child_weight': 1, 'n_estimators': 100, 'subsample': 1}
# 최상의 점수:  0.9824175824175825
# 테스트 스코어:  0.9473684210526315