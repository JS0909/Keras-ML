...
model = XGBRegressor(n_estimators = 500, learning_rate= 0.02, colsample_bytree =max(min(0.9472049545497058,1),0) ,
                     max_depth=int(round(6.666228114644168)), min_child_weight =int(round(1.0272673144212887)),
                      reg_alpha= max(7.920939589358731,0), reg_lambda=max(0.608055812194415,0), subsample=max(min(0.8584093098785359,1),0))
